...
from tensorflow.keras.layers import Activation, Conv2D, BatchNormalization, ZeroPadding2D, Dense, Reshape, Flatten, GlobalAveragePooling2D
...
class SEResNet(tf.keras.Model):
    ...
    def __init__(self, blocks, name='se-resnet50', block_type=BasicBlock):
        super().__init__()
